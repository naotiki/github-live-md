/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0785dc40ad9fa0a21bf551d3ca310a69)
...
interface __BaseEnv_Env {
	...
	EDITING_SESSIONS: DurableObjectNamespace<import("./worker/index").EditingSession>;
	SESSION_REGISTRY: DurableObjectNamespace<import("./worker/index").SessionRegistry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "EditingSession" | "SessionRegistry";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GITHUB_APP_SLUG">> {}
}
